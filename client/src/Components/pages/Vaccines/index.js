  ...
  return (
    ...
    <HeaderPages/>
      <div className="max-w-[1250px]  m-auto justify-center items-center mb-9">
        <img
          src="https://images.unsplash.com/photo-1618961734760-466979ce35b0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1332&q=80"
          alt=""
      ...
      <div className="max-w-[1250px]  m-auto justify-center items-center">
        ...
        <DataVaccinesCoutry report={report} />
